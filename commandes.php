...
$count=0;
$query="SELECT id_commande FROM commande WHERE id_commande IN ( SELECT id_commande FROM ligne_commande WHERE commande.id_client=ligne_commande.id_commande)";
$pdostmt=$pdo->prepare($query);
$pdostmt->execute();
$list = []; // Initialisation de la variable $list avant son utilisation
...
?>
<tr>
    <td><?php echo htmlspecialchars($ligne["id_commande"]); ?></td>
    <td><?php echo htmlspecialchars($ligne["id_client"]); ?></td>
    <td><?php echo htmlspecialchars($ligne["date"]); ?></td>
    <td>
        <a href="modifcommande.php?id=<?php echo $ligne["id_commande"]?>" class="btn btn-success">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="delete.php?idcmd=<?php echo $ligne["id_commande"] ?>" class="btn btn-danger">Supprimer</a>
            </div>
        </div>
    </div>
</div>
